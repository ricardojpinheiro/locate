...
Modificações pensadas para o futuro do programa:
1. Uso de dois ou mais parâmetros simultaneamente.  
2. Busca em nomes incompletos.  
3. Busca em diretórios.  
4. Diminuição da quantidade de variáveis usadas, limpeza de constantes e tipos não usados (já fiz alguma coisa, mas farei melhor depois).
