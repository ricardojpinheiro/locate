...
Sintaxe: updatedbmsx.py <arquivo de configurações>
...
Configuração: O <arquivo de configurações> deve seguir o seguinte formato: <caminho completo até o diretório que será indexado>,<letra do drive correspondente> Isto se repetirá para cada letra de drive.
...
/f  - Exibe o nome do arquivo, o caminho e o hash.
/ln - Para após n correspondências.
